...
class InsertScanLogOfflineUseCase @Inject constructor(private val localStorageRepository: LocalStorageRepository) {
    suspend fun invoke(scanLog: ScanLog): Flow<Long> {
        return flow {
            emit(localStorageRepository.insertScanLogDataLocalDB(scanLog))
