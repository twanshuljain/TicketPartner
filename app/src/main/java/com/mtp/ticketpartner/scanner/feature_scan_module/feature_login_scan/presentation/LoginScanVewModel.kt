...
import com.mtp.ticketpartner.scanner.feature_local_storage.domain.usecase.GetEventDetailsLocalDBUseCase
import com.mtp.ticketpartner.scanner.feature_local_storage.domain.usecase.InsertEventDetailsUseCase
import com.mtp.ticketpartner.scanner.feature_local_storage.domain.usecase.InsertQrCodeListUseCase
import com.mtp.ticketpartner.scanner.feature_local_storage.domain.usecase.InsertTicketTypesOfflineUseCase
...
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.GetCheckInDataOfflineScanUIState
...
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.GetQrCodeForOffLineScanUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertCheckInDataOfflineUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertEventDetailsResponse
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertEventDetailsUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertQrCodeForOffLineScanUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertScanReportDataResponse
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertScanReportDataUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertScanReportTicketListUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertSearchDataOfflineUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertTicketTypeListResponse
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.InsertTicketTypesOfflineScanUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.LoginWithPinUIState
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.model.SearchData
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.GetCheckInListOfflineUseCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.GetLoginWithPinUseCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.GetQrCodeListUseCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.GetQrScanAllReportLoginUseCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.GetScanEventDetailsUseCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.InsertCheckInDataOfflineUseCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.InsertScanReportDataUseCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.InsertScanReportTicketListUSeCase
import com.mtp.ticketpartner.scanner.feature_scan_module.feature_login_scan.domain.usecase.InsertSearchDataOfflineUseCase
...
class LoginScanVewModel @Inject constructor(
    ...
    private val _getScanReportAllDataLogin: MutableLiveData<QrScanReportAllUIState> =
        MutableLiveData()
    val getScanReportAllDataLogin: LiveData<QrScanReportAllUIState> = _getScanReportAllDataLogin

    private val _insertScanReportDataOffline: MutableLiveData<InsertScanReportDataUIState> =
        MutableLiveData()
    val insertScanReportDataOffline: LiveData<InsertScanReportDataUIState> =
        _insertScanReportDataOffline

    private val _insertScanReportTicketListDataOffline: MutableLiveData<InsertScanReportTicketListUIState> =
        MutableLiveData()
    val insertScanReportTicketListDataOffline: LiveData<InsertScanReportTicketListUIState> =
    ...
    fun insetQrCodeListForOfflineScan(getQrCodeListResponse: ArrayList<DataItems>) {
    ...
    fun insertCheckInDataOfflineScan(checkInData: ArrayList<CheckInData>) {
    ...
    fun insertSearchDataOfflineScan(searchData: ArrayList<SearchData>) {
    ...
    fun insertScanReportTicketListOffline(ticketDataList: ArrayList<TicketDataList>) {
        _insertScanReportTicketListDataOffline.value =
            InsertScanReportTicketListUIState.IsLoading(true)
        viewModelScope.launch {
