...
import com.example.ticketpartner.scan_module.domain.model.DataItem
...
class SelectTicketTypeScanModuleFragment : Fragment() {
    ...
    private fun initView() {
        adapter = SelectTicketTypeScanAdapter(requireActivity(), emptyList(),::selectedTicketNameList)
    ...
    private fun setTicketTypesAdapter(data: DataItem?) {
        adapter = SelectTicketTypeScanAdapter(requireActivity(), data?.event_tickets,::selectedTicketNameList)
